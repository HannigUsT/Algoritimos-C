...
int main(void)
{
  ...
  do
  {
    ...
    case 3: // Primeiramente o usuário vai digitar um número, todos os números até esse número que apresentarem o resto como 0 não serão primo pois os primos só são divisiveis por 1 e eles mesmos.
      printf("--------------------------------------------------------------------------\n");
    ...
    case 4:
      // O usúario vai digitar a quantidade de elementos para determinar a quantidade de números que ele vai digitar, o programa vai pegar o maior e o menor número de todos eles. Além disso, o programa vai fazer a média de todos os números digitados.
      printf("--------------------------------------------------------------------------\n");
    ...
    case 5:
      // O usúario só vai poder digitar um número de 1 a 20, se ele digitar menos que 1 ou mais que 20 o programa vai imprimir uma mensagem que esses números não fazem parte do programa, mas quando ele digitar de 1 a 20, o programa vai imprimir esse número em código morse.
      printf("--------------------------------------------------------------------------\n");
