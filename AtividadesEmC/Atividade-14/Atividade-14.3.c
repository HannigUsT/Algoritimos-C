...
int main(void)
{
  int x, Pessoas, contador, cont, contM, contH, N, contP, Num, controle,
      Numero, Elementos, maior, menor;
  float Dividendo, Divisor, Divisão, y, MediaI, mediaSexoM, mediaSexoH,
      Idade[Pessoas], Numeros[Elementos], MediaE;
  char sexo[Pessoas];

  // Primeiramente o programa vai printar na tela as escolhas do usúario, que
  // após isso vão entrar no switch X com o valor de 1 a 7 e logo assim
  // entrando nos cases.
  ...
  do
  {
    ...
    {
    case 1:
      // O usuário vai entrar com o Divisor e o Dividendo, o programa vai
      // fazer o calcúlo e imprimir na tela o resultado da Divisão.
    ...
    case 2:
      // Primeiramente o usúario vai entrar com quantas pessoas ele deseja
      // para calcular a faixa etária, após isso Ele vai digitar a idade e
      // o sexo de cada pessoa, sendo H para homem e M para mulher, com
      // todos os dados coletados o programa vai fazer o calcúlo da média
      // de idade de todas as pessoas, e também a média para cada sexo, e
      // após os calcúlos vai imprimir todas as médias na tela.
      ...
      for (int i = 1; i <= Pessoas; i++)
      {
        ...
        scanf("%f", &Idade[i]);
        printf(
            "Digite o sexo da pessoa, H para homem, M para mulher:\n");
        scanf("%s", &sexo[i]);
        printf("Sexo(%d):%c\n", i, sexo[i]);
        printf("Idade(%d):%f\n", i, Idade[i]);
      }
    ...
    case 3:
      printf("-----------------------------------------------------------"
             "---------------\n");
      printf("Escreva um número que deseja saber a soma de todos os "
      ...
      printf("-----------------------------------------------------------"
             "---------------\n");
      printf(
          "A soma de todos os números primos até %d é %d.\n", Num, contP);
      printf("-----------------------------------------------------------"
             "---------------\n");
